...
export function TenantLanding({ landingData }: TenantLandingProps) {
  ...
  const filteredProducts = availableProducts.filter((product) => {
    const matchesCategory =
      selectedProductCategory?.matches(product) ?? true;
    const matchesSearch =
  ...
  const heroPanelStyle: CSSProperties | undefined =
    brand.primary || brand.background
      ? {
          ...
          } 0%, ${brand.primary ?? 'rgba(59,130,246,0.12)'} 100%)`,
        }
      : undefined;
          ...
          <div className="flex flex-1 flex-col gap-6">
            <TabsContent value="home" className="mt-0 flex-1">
              <section className="mx-auto container">
                <div
                  className="relative overflow-hidden rounded-[2rem] border border-white/40 bg-card/80 px-6 py-8 shadow-[0_30px_80px_-40px_rgba(15,23,42,0.45)] backdrop-blur sm:px-8 sm:py-10 lg:px-10 lg:py-12"
                  style={heroPanelStyle}
                >
                  <div className="pointer-events-none absolute inset-y-0 right-0 hidden w-1/2 bg-gradient-to-l from-white/35 via-white/10 to-transparent lg:block" />
                  <div className="pointer-events-none absolute -left-20 top-0 h-56 w-56 rounded-full bg-white/25 blur-3xl" />
                  <div className="pointer-events-none absolute bottom-0 right-0 h-64 w-64 rounded-full bg-white/20 blur-3xl" />
                  ...
                  <div className="relative grid gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)] lg:items-center">
                    <div className="space-y-6">
                      <div className="space-y-4">
                        <div className="flex flex-wrap items-center gap-3">
                          <span
                            className="inline-flex rounded-full border border-white/50 bg-white/70 px-3 py-1 text-[0.7rem] font-semibold uppercase tracking-[0.24em] text-foreground/80 shadow-sm"
                            style={
                              brand.secondary
                                ? { color: brand.secondary }
                                : undefined
                      ...
                      <div className="flex flex-wrap gap-3">
                        ...
                        {isAuthenticated && user ? (
                          <Button
                            size="sm"
                            variant="outline"
                            className="min-w-36 bg-background/70"
                            disabled={
                              isRegistered ||
                      ...
                      {isAuthenticated && user && isRegistered ? (
                        <div className="flex flex-wrap items-center gap-3 rounded-2xl border bg-background/70 px-4 py-3 text-sm shadow-sm">
                        ...
                        <div className="space-y-3">
                          ...
                          <ul className="flex flex-wrap gap-2">
                            {featuredDepartments.map((d) => (
                              <li
                                key={d.id}
                                className="rounded-full border bg-background/70 px-3 py-1.5 text-sm text-foreground/80 shadow-sm"
                              >
                                {d.name}
                              </li>
                            ))}
                    ...
                    <aside className="relative">
                      <div className="overflow-hidden rounded-[1.75rem] border border-white/50 bg-background/85 p-3 shadow-[0_24px_60px_-32px_rgba(15,23,42,0.6)] backdrop-blur">
                        <div className="relative h-[260px] overflow-hidden rounded-[1.25rem] bg-muted/40 sm:h-[320px]">
                          <>
                            <img
                              src={heroImage}
                              alt={title}
                        ...
                        <div className="grid gap-3 p-4 sm:grid-cols-2">
                          <div className="rounded-2xl border bg-card/70 p-4">
                            ...
                            <code className="mt-2 inline-flex rounded bg-muted px-2 py-1 text-xs">
                              {slug || tenant.name}
                            </code>
                          </div>
                          <div className="rounded-2xl border bg-card/70 p-4">
                  ...
                  <div className="grid gap-5 lg:grid-cols-2">
                    {departments.map((dept, index) => {
                      ...
                      return (
                        <article
                          key={dept.id}
                          className="group relative flex h-full flex-col overflow-hidden rounded-[1.75rem] border bg-card/80 p-5 shadow-[0_22px_50px_-38px_rgba(15,23,42,0.7)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_28px_70px_-36px_rgba(15,23,42,0.65)] sm:p-6"
                          style={departmentStyle}
                        >
                          <div className="pointer-events-none absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-white/35 to-transparent opacity-80" />
                          ...
                          <div className="relative flex items-start justify-between gap-4">
                            <div className="space-y-3">
                              ...
                              <div className="flex flex-wrap gap-2">
                                <span className="rounded-full border bg-background/70 px-3 py-1 text-[0.7rem] font-medium uppercase tracking-[0.14em] text-muted-foreground">
                                ...
                                {dept.phone_number ? (
                                  <span className="rounded-full border bg-background/70 px-3 py-1 text-[0.7rem] text-muted-foreground">
                                    {dept.phone_number}
                                  </span>
                                ) : null}
                                {dept.email ? (
                          ...
                          <div className="relative mt-5 flex flex-wrap gap-2">
                            {dept.services.length > 0 ? (
                              dept.services.map((service) => (
                                <span
                                  key={service.id}
                                  className="rounded-full border bg-background/75 px-3 py-1.5 text-xs font-medium shadow-sm"
                                  style={
                                    brand.primary
                                      ? {
                                          borderColor: `${brand.primary}55`,
                          ...
                          {dept.services.some(
                            ...
                            <div className="relative mt-5 rounded-2xl border bg-background/65 p-4">
                        ...
                        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                          <div className="relative w-full max-w-xl">
                            ...
                            <Input
                              ...
                              className="h-12 rounded-full border bg-background/75 pl-11 pr-4 shadow-sm"
                            />
                          </div>
                            ...
                            {filteredProducts.map(
                              (product, index) => (
                                <article
                                  ...
                                  className="group flex h-full flex-col overflow-hidden rounded-[1.75rem] border bg-card/85 shadow-[0_22px_50px_-38px_rgba(15,23,42,0.7)] transition-shadow duration-300 hover:shadow-[0_28px_70px_-36px_rgba(15,23,42,0.65)]"
                                  style={
                                    brand.primary
                                      ? {
                                          borderColor: `${brand.primary}33`,
                                ...
                                >
                                  ...
                                  >
                                    <div className="absolute right-5 top-5 rounded-full border bg-background/80 px-3 py-1 text-[0.7rem] font-semibold uppercase tracking-[0.16em] text-muted-foreground shadow-sm">
                                      {product.price < 50
                                        ? 'Essential'
                                        : product.price < 150
                                          ? 'Popular'
                                    ...
                                    <div className="flex h-full items-end">
                                      <div
                                        className="flex h-14 w-14 items-center justify-center rounded-2xl border bg-background/80 text-lg font-semibold shadow-sm"
                                        style={
                                          brand.primary
                                            ? {
                                                borderColor: `${brand.primary}55`,
                                  ...
                                  <div className="flex flex-1 flex-col p-5">
                                    ...
                                    <div className="mt-5 flex items-center justify-between gap-3">
                                      <div className="rounded-full border bg-background/70 px-3 py-1 text-[0.7rem] uppercase tracking-[0.16em] text-muted-foreground">
                                        Tenant catalog
                                      </div>
                                      <Button
                                        size="sm"
