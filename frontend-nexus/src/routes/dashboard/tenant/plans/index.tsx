...
export function TenantPlansPanel() {
  ...
  const createMutation = useMutation({
    ...
    onError: (err) =>
      toast.error(isApiError(err) ? err.message : "Failed to create plan"),
  });
  ...
  const updateMutation = useMutation({
    ...
    onError: (err) =>
      toast.error(isApiError(err) ? err.message : "Failed to update plan"),
  });
  ...
  const toggleMutation = useMutation({
    ...
    onError: (err) =>
      toast.error(isApiError(err) ? err.message : "Failed to toggle plan"),
  });
  ...
  const handleEdit = (plan: TenantPlanApi) => {
    ...
    setFormState({
      ...
      max_appointments:
        plan.max_appointments != null ? String(plan.max_appointments) : "",
      max_consultations:
  ...
  return (
    <div className="space-y-6 p-4 sm:p-6 lg:p-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {editingPlanId != null ? "Edit plan" : "Add plan"}
          </CardTitle>
        </CardHeader>
      ...
      {plans.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Edit, toggle visibility, or remove plans.
            </CardDescription>
          </CardHeader>
