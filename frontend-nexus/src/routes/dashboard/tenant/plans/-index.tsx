...
export function TenantPlansPanel() {
  ...
  const createMutation = useMutation({
    ...
    onError: (err) =>
      toast.error(
        isApiError(err) ? err.message : 'Failed to create plan'
      ),
  });
  ...
  const updateMutation = useMutation({
    ...
    onError: (err) =>
      toast.error(
        isApiError(err) ? err.message : 'Failed to update plan'
      ),
  });
  ...
  const deleteMutation = useMutation({
    ...
    onError: (err) =>
      toast.error(
        isApiError(err) ? err.message : 'Failed to delete plan'
      ),
  });
  ...
  const toggleMutation = useMutation({
    ...
    onError: (err) =>
      toast.error(
        isApiError(err) ? err.message : 'Failed to toggle plan'
      ),
  });
