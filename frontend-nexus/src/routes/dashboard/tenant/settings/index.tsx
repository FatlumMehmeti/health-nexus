...
export function TenantDetailsEditor() {
  ...
  const saveMutation = useMutation({
    mutationFn: (
      payload: Parameters<typeof tenantsService.updateTenantDetails>[0],
    ...
    <div className="space-y-6 p-4 sm:p-6 lg:p-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Manage tenant branding, fonts, and landing page content.
        </p>
      </div>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Edit logo, imagery, title, moto, brand palette, fonts, and about
            text used by the landing page.
          </CardDescription>
        </CardHeader>
