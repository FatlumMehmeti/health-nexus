      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {tenants.map((tenant) => (
          <Link
            ...
            to={
              tenant.slug ? '/landing/$tenantSlug' : '/landing-demo'
            }
            params={
              tenant.slug ? { tenantSlug: tenant.slug } : undefined
            }
          ...
          >
            <div className="relative h-40">
              ...
              {tenant.logo ? (
                ...
                <div className="absolute left-4 top-4 flex h-10 w-10 items-center justify-center rounded-2xl bg-black/40 text-white backdrop-blur">
                  <tenant.icon className="h-5 w-5" />
                </div>
              )}
            </div>
