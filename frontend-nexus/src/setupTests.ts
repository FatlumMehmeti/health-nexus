...
if (typeof globalThis.Response !== 'undefined') {
  ...
  ;(global as unknown as { Response: typeof ResponseConstructor }).Response = ResponseConstructor
  if (typeof (global as unknown as { window?: unknown }).window !== 'undefined') {
    ((global as unknown as { window: unknown }).window as unknown as { Response: typeof ResponseConstructor }).Response = ResponseConstructor
  }
}
...
if (typeof (global as unknown as { window?: unknown }).window !== 'undefined') {
  ((global as unknown as { window: unknown }).window as unknown as { ResizeObserver: unknown }).ResizeObserver = ResizeObserverMock
}
...
;(global as unknown as { matchMedia: () => ReturnType<typeof matchMediaMock> }).matchMedia = matchMediaMock
if (typeof (global as unknown as { window?: unknown }).window !== 'undefined') {
  ((global as unknown as { window: { matchMedia: () => unknown } }).window as unknown as { matchMedia: () => unknown }).matchMedia = matchMediaMock
}
