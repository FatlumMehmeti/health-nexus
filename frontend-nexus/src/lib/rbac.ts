...
export function can(user: UserWithRole | null | undefined, permission: RouteKey): boolean {
  return canAccess(user?.role ?? undefined, permission)
}

export { type Role, type RouteKey, canAccess, getAllowedRoles } from './rbacMatrix'
