...
from app.routes import user_router, role_router, superadmin_tenant_router, public_tenant_router, tenant_audit_log, tenant_manager_router, patient_router, doctor_router
